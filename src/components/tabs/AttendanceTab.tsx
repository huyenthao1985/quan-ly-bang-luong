  ...
  <div>
    ...
    <div className="flex gap-1">
      <select value={h} onChange={e => onH(Number(e.target.value))}
        className="flex-1 px-2 py-2 text-xs bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-800 dark:text-slate-200 font-semibold">
      ...
      <select value={ampm} onChange={e => onAP(e.target.value as 'AM' | 'PM')}
        className="px-2 py-2 text-xs bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-800 dark:text-slate-200 font-semibold">
