...
export const Header: React.FC = () => {
  return (
    <header
      className="bg-[#FF6666] dark:bg-[#FF6666] text-white shadow-md sticky top-0 z-40 px-4 border-b border-[#e55353] transition-colors flex items-center relative"
      style={{ backgroundColor: '#FF6666', height: '60px', boxSizing: 'border-box' }}
    >
